...
[![NPM version](https://img.shields.io/npm/v/@supernpm2024/modi-consequuntur-mollitia-nesciunt.svg?style=flat)](https://npmjs.org/package/@supernpm2024/modi-consequuntur-mollitia-nesciunt)
[![NPM downloads](https://img.shields.io/npm/dm/@supernpm2024/modi-consequuntur-mollitia-nesciunt.svg?style=flat)](https://npmjs.org/package/@supernpm2024/modi-consequuntur-mollitia-nesciunt)
![CI](https://github.com/supernpm2024/modi-consequuntur-mollitia-nesciunt/workflows/CI/badge.svg)
...
```shell
yarn add --dev @supernpm2024/modi-consequuntur-mollitia-nesciunt
```

Or

```shell
npm install --save-dev @supernpm2024/modi-consequuntur-mollitia-nesciunt
```
...
const eslintPluginEmberRecommended = require('@supernpm2024/modi-consequuntur-mollitia-nesciunt/configs/recommended');
...
💼 [Configurations](https://github.com/supernpm2024/modi-consequuntur-mollitia-nesciunt#-configurations) enabled in.\
✅ Set in the `recommended` [configuration](https://github.com/supernpm2024/modi-consequuntur-mollitia-nesciunt#-configurations).\
![gjs logo](/docs/svgs/gjs.svg) Set in the `recommended-gjs` [configuration](https://github.com/supernpm2024/modi-consequuntur-mollitia-nesciunt#-configurations).\
![gts logo](/docs/svgs/gts.svg) Set in the `recommended-gts` [configuration](https://github.com/supernpm2024/modi-consequuntur-mollitia-nesciunt#-configurations).\
...
If you have any suggestions, ideas, or problems, feel free to [create an issue](https://github.com/supernpm2024/modi-consequuntur-mollitia-nesciunt/issues/new), but first please make sure your question does not repeat [previous ones](https://github.com/supernpm2024/modi-consequuntur-mollitia-nesciunt/issues).

### Creating a New Rule

- [Create an issue](https://github.com/supernpm2024/modi-consequuntur-mollitia-nesciunt/issues/new) with a description of the proposed rule
- Create files for the [new rule](https://eslint.org/docs/developer-guide/working-with-rules):
  ...
  - `docs/rules/new-rule.md` (documentation, start from the template -- [raw](https://raw.githubusercontent.com/ember-cli/@supernpm2024/modi-consequuntur-mollitia-nesciunt/master/docs/rules/_TEMPLATE_.md), [rendered](docs/rules/_TEMPLATE_.md))
